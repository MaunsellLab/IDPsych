...
IncStaircase = allStaircase([IDPsychTrials(:).taskMode] == 1, :);
DecStaircase = allStaircase([IDPsychTrials(:).taskMode] == 0, :);
...
xlabel('Trial Number');
ylabel('Coherence (%)');
title(['Averaged Inc/Dec Staircases | N = ', num2str(nFiles)]);
